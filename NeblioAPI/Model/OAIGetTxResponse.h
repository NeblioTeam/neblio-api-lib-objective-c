...
@class OAIGetTxResponseVin;
@protocol OAIGetTxResponseVout;
@class OAIGetTxResponseVout;
...
@interface OAIGetTxResponse : OAIObject
 ...
 */
@property(nonatomic) NSArray<OAIGetTxResponseVin>* vin;
/* Array of transaction outputs [optional]
 */
@property(nonatomic) NSArray<OAIGetTxResponseVout>* vout;
