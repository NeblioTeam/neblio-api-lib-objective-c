...
@interface OAITestnetInsightApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation OAITestnetInsightApi

NSString* kOAITestnetInsightApiErrorDomain = @"OAITestnetInsightApiErrorDomain";
NSInteger kOAITestnetInsightApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) testnetGetAddressWithAddress: (NSString*) address
    ...
    if (address == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kOAITestnetInsightApiErrorDomain code:kOAITestnetInsightApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
