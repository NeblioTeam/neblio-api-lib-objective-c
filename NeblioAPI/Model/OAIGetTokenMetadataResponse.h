...
@class OAIGetTokenMetadataResponseMetadataOfIssuance;



@protocol OAIGetTokenMetadataResponse
@end

@interface OAIGetTokenMetadataResponse : OAIObject
...
@property(nonatomic) OAIGetTokenMetadataResponseMetadataOfIssuance* metadataOfIssuance;

@property(nonatomic) OAIGetTokenMetadataResponseMetadataOfIssuance* metadataOfUtxo;
