...
@interface SWGTestnetNTP1Api ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation SWGTestnetNTP1Api

NSString* kSWGTestnetNTP1ApiErrorDomain = @"SWGTestnetNTP1ApiErrorDomain";
NSInteger kSWGTestnetNTP1ApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) testnetBroadcastTxWithBody: (SWGBroadcastTxRequest*) body
    ...
    if (body == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGTestnetNTP1ApiErrorDomain code:kSWGTestnetNTP1ApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
