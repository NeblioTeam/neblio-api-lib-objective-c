#import "NEBLResponseDeserializer.h"
#import <JSONModel/JSONModel.h>
#import <ISO8601/ISO8601.h>

NSString *const NEBLDeserializationErrorDomainKey = @"NEBLDeserializationErrorDomainKey";

NSInteger const NEBLTypeMismatchErrorCode = 143553;

NSInteger const NEBLEmptyValueOccurredErrorCode = 143509;

NSInteger const NEBLUnknownResponseObjectErrorCode = 143528;


@interface NEBLResponseDeserializer ()
...
@implementation NEBLResponseDeserializer
...
-(NSError *)typeMismatchErrorWithExpectedType:(NSString *)expected data:(id)data {
    ...
    return [NSError errorWithDomain:NEBLDeserializationErrorDomainKey code:NEBLTypeMismatchErrorCode userInfo:userInfo];
}
...
-(NSError *)emptyValueOccurredError {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:NEBLDeserializationErrorDomainKey code:NEBLEmptyValueOccurredErrorCode userInfo:userInfo];
}
...
-(NSError *)unknownResponseErrorWithExpectedType:(NSString *)expected data:(id)data  {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:NEBLDeserializationErrorDomainKey code:NEBLUnknownResponseObjectErrorCode userInfo:userInfo];
}
