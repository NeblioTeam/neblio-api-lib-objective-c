...
@interface NEBLNTP1Api ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation NEBLNTP1Api

NSString* kNEBLNTP1ApiErrorDomain = @"NEBLNTP1ApiErrorDomain";
NSInteger kNEBLNTP1ApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) broadcastTxWithBroadcastTxRequest: (NEBLBroadcastTxRequest*) broadcastTxRequest
    ...
    if (broadcastTxRequest == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kNEBLNTP1ApiErrorDomain code:kNEBLNTP1ApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
