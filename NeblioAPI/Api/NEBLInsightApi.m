...
@interface NEBLInsightApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation NEBLInsightApi

NSString* kNEBLInsightApiErrorDomain = @"NEBLInsightApiErrorDomain";
NSInteger kNEBLInsightApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) getAddressWithAddress: (NSString*) address
    ...
    if (address == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kNEBLInsightApiErrorDomain code:kNEBLInsightApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
