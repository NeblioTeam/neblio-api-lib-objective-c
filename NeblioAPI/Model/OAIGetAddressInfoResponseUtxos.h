...
@class OAIGetAddressInfoResponseTokens;
...
@interface OAIGetAddressInfoResponseUtxos : OAIObject
 ...
 */
@property(nonatomic) NSArray<OAIGetAddressInfoResponseTokens>* tokens;
