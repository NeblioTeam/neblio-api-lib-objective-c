...
@interface SWGInsightApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation SWGInsightApi

NSString* kSWGInsightApiErrorDomain = @"SWGInsightApiErrorDomain";
NSInteger kSWGInsightApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) getAddressWithAddress: (NSString*) address
    ...
    if (address == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGInsightApiErrorDomain code:kSWGInsightApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
