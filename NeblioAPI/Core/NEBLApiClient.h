 ...
 */
extern NSString *const NEBLResponseObjectErrorKey;


@interface NEBLApiClient : AFHTTPSessionManager

@property (nonatomic, strong, readonly) id<NEBLConfiguration> configuration;

@property(nonatomic, assign) NSTimeInterval timeoutInterval;

@property(nonatomic, strong) id<NEBLResponseDeserializer> responseDeserializer;

@property(nonatomic, strong) id<NEBLSanitizer> sanitizer;
