...
@interface OAINTP1Api ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation OAINTP1Api

NSString* kOAINTP1ApiErrorDomain = @"OAINTP1ApiErrorDomain";
NSInteger kOAINTP1ApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) broadcastTxWithBroadcastTxRequest: (OAIBroadcastTxRequest*) broadcastTxRequest
    ...
    if (broadcastTxRequest == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kOAINTP1ApiErrorDomain code:kOAINTP1ApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
