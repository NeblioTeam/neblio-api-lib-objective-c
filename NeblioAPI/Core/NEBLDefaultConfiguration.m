...
#import "NEBLBasicAuthTokenProvider.h"
#import "NEBLLogger.h"

@interface NEBLDefaultConfiguration ()
...
@implementation NEBLDefaultConfiguration

#pragma mark - Singleton Methods

+ (instancetype) sharedConfig {
    static NEBLDefaultConfiguration *shardConfig = nil;
...
- (instancetype) init {
    ...
    if (self) {
        ...
        _mutableDefaultHeaders[@"User-Agent"] = @"neblio-api-objective-c/1.2.1";
        _logger = [NEBLLogger sharedLogger];
    }
    return self;
}
...
- (NSString *) getBasicAuthToken {
    ...
    NSString *basicAuthToken = [NEBLBasicAuthTokenProvider createBasicAuthTokenWithUsername:self.username password:self.password];
