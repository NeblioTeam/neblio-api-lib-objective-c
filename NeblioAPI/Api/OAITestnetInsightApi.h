...
@interface OAITestnetInsightApi: NSObject <OAIApi>

extern NSString* kOAITestnetInsightApiErrorDomain;
extern NSInteger kOAITestnetInsightApiMissingParamErrorCode;
