...
@interface OAIInsightApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation OAIInsightApi

NSString* kOAIInsightApiErrorDomain = @"OAIInsightApiErrorDomain";
NSInteger kOAIInsightApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) getAddressWithAddress: (NSString*) address
    ...
    if (address == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kOAIInsightApiErrorDomain code:kOAIInsightApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/ins/addr/{address}"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"OAIGetAddressResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAIGetAddressResponse*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) getAddressBalanceWithAddress: (NSString*) address
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/ins/addr/{address}/balance"];
...
-(NSURLSessionTask*) getAddressTotalReceivedWithAddress: (NSString*) address
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/ins/addr/{address}/totalReceived"];
...
-(NSURLSessionTask*) getAddressTotalSentWithAddress: (NSString*) address
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/ins/addr/{address}/totalSent"];
...
-(NSURLSessionTask*) getAddressUnconfirmedBalanceWithAddress: (NSString*) address
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/ins/addr/{address}/unconfirmedBalance"];
...
-(NSURLSessionTask*) getAddressUtxosWithAddress: (NSString*) address
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/ins/addr/{address}/utxo"];
...
-(NSURLSessionTask*) getBlockWithBlockhash: (NSString*) blockhash
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/ins/block/{blockhash}"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"OAIGetBlockResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAIGetBlockResponse*)data, error);
                                }
                            }];
}
...
///
///  @returns OAIGetBlockIndexResponse*
///
-(NSURLSessionTask*) getBlockIndexWithBlockindex: (NSNumber*) blockindex
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/ins/block-index/{blockindex}"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"OAIGetBlockIndexResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAIGetBlockIndexResponse*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) getRawTxWithTxid: (NSString*) txid
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/ins/rawtx/{txid}"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"OAIGetRawTxResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAIGetRawTxResponse*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) getStatusWithQ: (NSString*) q
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/ins/status"];
...
-(NSURLSessionTask*) getSyncWithCompletionHandler: 
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"OAIGetSyncResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAIGetSyncResponse*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) getTxWithTxid: (NSString*) txid
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/ins/tx/{txid}"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"OAIGetTxResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAIGetTxResponse*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) getTxsWithAddress: (NSString*) address
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/ins/txs"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"OAIGetTxsResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAIGetTxsResponse*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) sendTxWithSendTxRequest: (OAISendTxRequest*) sendTxRequest
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/ins/tx/send"];
